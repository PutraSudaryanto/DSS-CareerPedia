 ...
 * @version 1.0
 * @copyright &copy; 2012 Nirwasita Studio
 *
...
class Utility
{
	...
	*/
	...
	public static function getPublish($url, $id, $type) {
		...
		if($id == '1') {
			$publish = '<a href="'.$url.'" title="'.$min.'"><img src="'.Yii::app()->theme->baseUrl.'/images/icons/publish.png" alt="'.$plus.'"></a>';
		} else {
			$publish = '<a href="'.$url.'" title="'.$plus.'"><img src="'.Yii::app()->theme->baseUrl.'/images/icons/unpublish.png" alt="'.$min.'"></a>';
		}
