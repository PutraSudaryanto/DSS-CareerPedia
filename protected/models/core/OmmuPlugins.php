...
class OmmuPlugins extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('plugin_id, defaults, install, actived, orders, folder, code, model, name, desc, version, icon, created_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'created_date' => Phrase::trans(443,0),
		);
	}
	...
	public function search()
	{
		...
		if($this->created_date != null && !in_array($this->created_date, array('0000-00-00 00:00:00', '0000-00-00')))
			$criteria->compare('date(t.created_date)',date('Y-m-d', strtotime($this->created_date)));
	...
	public function getGridColumn($columns=null) {
		if($columns !== null) {
			...
			$this->defaultColumns[] = 'created_date';
		}
